						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Date Change<small>Report </small></h1>
								</div>
							</div>
...
<?php
							...
							$q = ' insert into date values("'.$start.'","'.$end.'") ';
							...
							echo '<h3 class = "center"><a class="button center" href="date.php">Back to  Date page</a></h3>';
