	...
	<li>
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Add Subject <small>Enter the Details </small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="add_student_form" role="form" action="add_subject_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
									        ...
									        <TABLE id="dataTable" class="table table-striped table-bordered">
									          <TR>
									            ...
									            <TD class="center"> Acronym </TD>
									            <TD class="center"> Subject Name </TD>
									            <TD class="center"> Credits </TD>
									            <TD class="center"> Max Marks </TD>
									          </TR>
									          <TR>
									            <TD> 1 </TD>
									            <TD class="center"> 
									            	<INPUT type="text" style="width:125px;" name="subid[]"/>
									            </TD>
									            <TD class="center"> 
									            	<INPUT type="text" style="width:75px;" name="acronym[]"/> 
									            </TD>
									            <TD class="center"> 
									            ...
									            <TD>
									            	<SELECT name="maxmarks[]" class="form-control">
									            		<?php
															for($i=50;$i<=150;$i+=50)
										                  	{
										                    	echo '<option value='.$i.'>'.$i;
		...
		<script>
			...
			function addRow(tableID) 
			{
			      ...
			      element3.type = "text";
			      element3.style.width = '75px';
			      element3.name = "acronym[]";
			      ...
			      for(var i = 50; i <= 150; i+=50) 
			      {
			            var op = new Option();
			            op.text = op.value = i;
			            element6.options.add(op);
			      }
			      element6.className = "form-control";
			      element6.name = "maxmarks[]";
