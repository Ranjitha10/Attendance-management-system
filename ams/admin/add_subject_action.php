...
<html lang="en">
	<head>
		<title>Admin - Details of Added Subjects</title>
		<meta charset="utf-8" />
				...
				<div class="main-content">
					<div class="container">
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Subjects Added <small>Report </small></h1>
								</div>
							</div>
						...
						<?php
						    ...
						    $txtbox1 = $_POST['subid'];
						    $txtbox2 = $_POST['subname'];
						    $txtbox3 = $_POST['acronym'];
						    $txtbox4 = $_POST['credits'];
						    $txtbox5 = $_POST['maxmarks'];
						    $dept = $_SESSION['username'];
						    $successful = array();
						    $unsuccessful = array();
						    $k=$j=0;
						    foreach($txtbox1 as $key => $n ) 
						    {
						      	$qry = 'INSERT INTO subject VALUES ("'.$n.'","'.$txtbox2[$key].'","'.$txtbox3[$key].'","'.$dept.'","'.$txtbox4[$key].'","'.$txtbox5[$key].'")';
						      	$res=mysqli_query($con,$qry);
						      	if( !$res)
								{
									$unsuccessful[$k][0] = $n;
									$unsuccessful[$k][1] = $txtbox2[$key];
									$unsuccessful[$k][2] = $txtbox3[$key];
									$unsuccessful[$k][3] = $txtbox4[$key];
									$unsuccessful[$k++][4] = $txtbox5[$key];
								}
								else
								{
									$successful[$j][0] = $n;
									$successful[$j][1] = $txtbox2[$key];
									$successful[$j][2] = $txtbox3[$key];
									$successful[$j][3] = $txtbox4[$key];
									$successful[$j++][4] = $txtbox5[$key];
							...
							else
							{
								echo '<h3 class="center">';
									echo 'Subject Data Uploaded Successfully';
								echo '</h3>';
							...
							{
								echo '<h3 class="center">';
									echo 'Student Data Not Uploaded (Subject ID already present) ';
								echo '</h3>';
								echo '<table class="table table-striped table-bordered table-hover table-full-width"> ';
									echo '<thead><tr>';
										echo '<th>Sl No.</th>';
									...
									echo '<tbody>';
										...
										{	
											...
											echo '</td> <td>';
											echo $unsuccessful[$i][2];
											echo '</td> <td>';
											echo $unsuccessful[$i][3];
											echo '</td> <td>';
											echo $unsuccessful[$i][4];
											echo '</td> </tr>';
										}
									echo '</tbody>';
								echo '</table>';
							...
							echo '<h3 class = "center"><a class="button center" href="add_subject.php">Back to Change Scheme </a></h3>';
							echo '</div></div></div>';
						    mysqli_close($con);
						?>
						<!-- end: PAGE CONTENT-->
