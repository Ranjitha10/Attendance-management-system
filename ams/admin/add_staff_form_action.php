				...
				<div class="main-content">
					<div class="container">
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>New Staff <small>Report </small></h1>
								</div>
							</div>
						...
						<?php
							...
							$type = $_POST['type'];
							echo '<div class="row"><div class="col-sm-1"></div><div class="col-sm-10"><div class="panel panel-white"><div class="panel-body">';
							$con = mysqli_connect("localhost","root","root","attendance");
							$q = ' insert into staff values("'.$id.'","'.$name.'","'.$user.'","'.$year.'","'.$email.'","'.$phno.'","'.$address.'","'.$des.'","'.$type.'") ';
							...
							{
								echo '<h3 class="center">';
									echo 'Staff Data Not Uploaded (Staff already present) ';
								echo '</h3>';
								echo '<table class="table table-striped table-bordered table-hover table-full-width"> ';
									echo '<tr>';
										echo '<td>Staff ID</td>';
							...
							echo '<h3 class = "center"><a class="button center" href="add_staff_form.php">Back to Add Staff page</a></h3>';
