...
<html lang="en">
	<head>
		<title>Admin - Upload Student Details</title>
		<meta charset="utf-8" />
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Upload Student<small>Details of Uploaded Students</small></h1>
								</div>
							</div>
						...
						<?php
							...
							if( (($ext=="xls") || ($ext=="xlsx")) && in_array($extension, $allowedExts) )
							{
								...
								else
								{
									...
									define("UPLOAD_DIR", "uploads/student_details/");
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											$sql = ' insert into student values( "'.$data[$i][0].'" , "'.$data[$i][1].'" , "'.$dept.'" , "'.$data[$i][2].'" , "'.$data[$i][3].'" , "'.$data[$i][4].'" , "'.$data[$i][5].'" , "'.$data[$i][6].'" , "'.$data[$i][7].'" , "'.$data[$i][8].'") ';
										...
										{
											echo '<h3 class="center">';
												echo 'Student Data Not Uploaded (USN already present) ';
											echo '</h3>';
											echo '<table class="table table-striped table-bordered table-hover table-full-width"> ';
												echo '<thead><tr>';
													echo '<th>Sl No.</th>';
										...
										echo '<h3 class = "center"><a class="button center" href="add_student_excel.php">Back to Upload page</a></h3>';
										echo '</div></div></div>';
							...
							{
								echo '<div class="row"><div class="col-sm-2"></div><div class="col-sm-8"><div class="panel panel-white"><div class="panel-body">';
								echo '<h3 class = "center">Wrong Format Uploaded <br><br> <a class="button center" href="add_student_excel.php">Back to Upload Page</a></h3>';
								echo '</div></div></div>';
