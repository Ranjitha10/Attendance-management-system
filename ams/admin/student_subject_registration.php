						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Register Students<small>Register Students for Subjects</small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="upload_form" role="form" action="student_subject_registration_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="portfolio-item center">
												<a class="thumb-info" href="samples/reg.bmp" data-lightbox="gallery" data-title="Sample">
