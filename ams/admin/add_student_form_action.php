...
<html lang="en">
	<head>
		<title>Admin - Add Student Details</title>
		<meta charset="utf-8" />
					  ...
					  <div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Student Added <small>Report </small></h1>
								</div>
							</div>
						...
						<?php
							...
							$fatphno = $_POST['fatphno'];
							
							echo '<div class="row"><div class="col-sm-2"></div><div class="col-sm-8"><div class="panel panel-white"><div class="panel-body">';
							$qry= 'INSERT INTO student VALUES ("'.$usn.'","'.$name.'","'.$dept.'","'.$year.'","'.$email.'","'.$phno.'","'.$address.'","'.$fatname.'","'.$fatemail.'","'.$fatphno.'")';	
							...
							if($result)
							{
								...
								echo '</h3>';
								echo '<table class="table table-striped table-bordered table-hover hover table-full-width"> ';
									echo '<tr> <td>';
										echo "<b>USN<b></td> <td>"; 
										echo $usn;
									echo '</td> </tr>';
									...
									echo '</td> </tr>';
									echo '<tr> <td>';
										echo "<b>Year of Joining</b></td> <td>";
										echo $year;
									echo '</td> </tr>';
									echo '<tr> <td>';
										echo "<b>E-mail ID</b></td> <td>";
										echo $email;
									echo '</td> </tr>';
									echo '<tr> <td>';
										echo "<b>Phone Number</b></td> <td>";
										echo $phno;
									echo '</td> </tr>';
									echo '<tr> <td>';
										echo "<b>Address</b></td> <td>";
										echo $address;
									echo '</td> </tr>';
									echo '<tr> <td>';
										echo "<b>Father's Name</b></td> <td>";
										echo $fatname;
									echo '</td> </tr>';
									echo '<tr> <td>';
										echo "<b>Father's E-mail ID</b></td> <td>";
										echo $fatemail;
									echo '</td> </tr>';
									echo '<tr> <td>';
										echo "<b>Father's Phone Number</b></td> <td>";
										echo $fatphno;
									echo '</td> </tr>';
							...
							{
								echo '<h3 class="center">';
									echo 'USN already exists. Student not added.';
								echo '</h3>';
								echo '<table class="table table-striped table-bordered table-hover hover table-full-width"> ';
							...
							echo '<hr/>';
							echo '<br/><h3 class = "center"><a class="button center" href="add_student_form.php">Back to Add Student page</a></h3>';
