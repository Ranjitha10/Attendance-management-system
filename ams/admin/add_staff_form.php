...
<html lang="en">
	...
	<li>
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Add Staff <small>Register New Staff </small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="add_staff_form" role="form" action="add_staff_form_action.php" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validation()">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="staff_id" type="text" class="form-control" placeholder="Staff ID">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="name" type="text" class="form-control" placeholder="Staff Name">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="phno" type="text" class="form-control" placeholder="Phone Number">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="designation" class="form-control search-select">
		...
		{
		  /*Staff ID Validation*/
		  x = document.forms["add_staff_form"]["staff_id"].value;
		  ...
		  if(!(x.match(regexp)))
			{
				alert("Invalid Staff ID! Enter only alphabets/numbers.");
				return false;
		  }	 

		  /*Name Validation*/
		  var x=document.forms["add_staff_form"]["name"].value; 
		  if (x==null || x=="")
		  {
		  ...
		  /* E-mail Validation */
		  x=document.forms["add_staff_form"]["email"].value;
		  var atpos=x.indexOf("@");
		  ...
		  x=document.forms["add_staff_form"]["phno"].value;
		  if (x==null || x=="")
		    {
		  ...
		  /*Address Validation*/
		  var x=document.forms["add_staff_form"]["address"].value; 
		  if (x==null || x=="")
		  {
		  ...
		  var x=document.forms["add_staff_form"]["fatname"].value; 
		  if (x==null || x=="")
		  {
		  ...
		  x=document.forms["add_staff_form"]["fatemail"].value;
		  var atpos=x.indexOf("@");
		  var dotpos=x.lastIndexOf(".");
		  if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length)
		  {
		  ...
		  x=document.forms["add_staff_form"]["fatphno"].value;
		  if (x==null || x=="")
		    {
		    alert("Father's Phone Number must be filled out");
		    return false;
		    }
