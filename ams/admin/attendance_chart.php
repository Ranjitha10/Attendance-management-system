								...
								<div class="col-sm-8">
									<div class="panel panel-white">
										<div class="panel-body">
											<form name="view_marks_form" id="view_marks_form" role="form" action ="attendance_chart_inter.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input id="subid" name="subid" type="text" placeholder="Eg : 10IS40 " class="form-control">
													</div>
												</div>
														<button class="btn btn-green btn-lg btn-block" align = "center" onclick="return validate();">Generate Chart
