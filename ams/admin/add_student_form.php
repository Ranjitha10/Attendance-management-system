...
<html lang="en">
	...
	<li>
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>New Student <small>Student Register Form </small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="add_student_form" role="form" action="add_student_form_action.php" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validation()">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="usn" type="text" placeholder="E.g. 1RV11IS062" class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="name" type="text" placeholder="Student Name" class="form-control">
												</div>
											</div>

											<div class="form-group">
												<label class="col-sm-3 control-label" for="form-field-1">
													Select Academic Year of Joining
												</label>
												<div class="col-sm-9">
													<select name="acad" placeholder="E.g. 2011" class="form-control search-select">
														<?php
															for($i=2015;$i<2020;$i++)
										                  	{
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="email" type="text" placeholder="Eg : abc@xyz.com " class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="phno" type="text" placeholder="Eg : 8095659253 " class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="fatname" type="text" placeholder="Father's Name" class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="fatemail" type="text" placeholder="Eg : abc@xyz.com " class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="fatphno" type="text" placeholder="Eg : 8095659253 " class="form-control">
												</div>
											</div>
		...
		{
		  /*USN Validation*/
		  x = document.forms["add_student_form"]["usn"].value;
		  s1=x.search(/^[1-4][A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{3}$/);
		  if (x==null || x=="")
		  {
		  ...
		  if(s1<0)
		  {
		    alert("This is not a valid USN number, A Valid USN Number is like 1RV11IS053. ");
		    return false;
		}

		  /*Name Validation*/
		  var x=document.forms["add_student_form"]["name"].value; 
		  if (x==null || x=="")
		  {
		  ...
		  /* E-mail Validation */
		  x=document.forms["add_student_form"]["email"].value;
		  var atpos=x.indexOf("@");
		  ...
		  x=document.forms["add_student_form"]["phno"].value;
		  if (x==null || x=="")
		    {
		  ...
		  /*Address Validation*/
		  var x=document.forms["add_student_form"]["address"].value; 
		  if (x==null || x=="")
		  {
		  ...
		  var x=document.forms["add_student_form"]["fatname"].value; 
		  if (x==null || x=="")
		  {
		  ...
		  /*Father's E-mail Validation */
		  x=document.forms["add_student_form"]["fatemail"].value;
		  var atpos=x.indexOf("@");
		  var dotpos=x.lastIndexOf(".");
		  if(x)
		  if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length)
		  {
		    alert("Invalid Father's email address");
		    return false;
		  }

		  /* Father's Phone Number Validation*/
		  x=document.forms["add_student_form"]["fatphno"].value;
		  if(x)
		  {
		  	if(!x.match(/^\d+/))
		  	{
		    	alert("Father's Phone Number must be numeric characters");
		    	return false;
		  	}

			if(x.length!=10&&x.length!=8&&x.length!=11)
			{
			alert("Wrong Father's Phone Number Format");
			return false;
			}
		  }
		  /*Mother Name Validation*/
		  var x=document.forms["add_student_form"]["motname"].value; 
		  if (x==null || x=="")
		  {
		  ...
		  /*Mother's E-mail Validation */
		  x=document.forms["add_student_form"]["motemail"].value;
		  var atpos=x.indexOf("@");
		  var dotpos=x.lastIndexOf(".");
		  if(x)
		  if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length)
		  {
		    alert("Invalid Mother's email address");
		    return false;
		  }

		  /*Mother's Phone Number Validation*/
		  x=document.forms["add_student_form"]["motphno"].value;
		  if(x)
		  {
			  if(!x.match(/^\d+/))
			  {
			    alert("Mother's Phone Number must be numeric characters");
			    return false;
			  }

			  if(x.length!=10&&x.length!=8&&x.length!=11)
			  {
			    alert("Wrong Mother's Phone Number Format");
			    return false;
			  }
		  }
