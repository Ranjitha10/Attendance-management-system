						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Change date <small>Register New Staff </small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="add_staff_form" role="form" action="date_action.php" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validation()">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="start" type="text" class="form-control" placeholder="Enter Date">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="end" type="text" class="form-control" placeholder="Enter Date">
												</div>
											</div>
