...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="assets/css/plugins.css">
		<link rel="stylesheet" href="assets/plugins/jstree/dist/themes/default/style.css">
				...
				<div class="container">
					<div class="navbar-header">
						...
						<div class="navbar-brand center">
							...
							RVCE ATTENDANCE MANAGMENT SYSTEM</div>
						<!-- end: LOGO -->
					</div>
...
<li>
								<a href="javascript:void(0)"><i class="fa fa-table"></i> <span class="title"> Date </span><i class="fa fa-chevron-down pull-right"></i> </a>
								<ul class="sub-menu">
									<li>
										<a href="date.php">
											<span class="title"> Set date </span>
										</a>
									</li>
			...
			<div class="main-container inner">
				...
				<div class="main-content">
					<div class="container">
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Home <small>Admin Home </small></h1>
								</div>
							</div>
							<div class="col-sm-6" style="color: #333366;">
								<div class="col-sm-2">
						...
						<div class="row">
							<div class="panel">
								<div class="panel-body">
									<div class="col-sm-12">
										<h1 class="animated center bounceInRight text-extra-large text-red">Welcome <?php echo $_SESSION["username"]; ?></h1>
									</div>
								</div>
							</div>
						</div>-->
						...
						<div class="col-sm-12">
							<h1 class="center text-extra-large text-red">Welcome <?php echo $_SESSION["username"]; ?></h1>
						</div>
								...
								<div class="panel">
									<div class="panel-body">
										<div class="easy-pie-chart">
											<span class="cpu number appear" data-percent="85.92" data-plugin-options='{"barColor": "#ff0000"}'> <span class="percent"></span> </span>
											<div class="label-chart">
												<br />
												<br />
												<h4 class="no-margin"><b>Semester Complete	</b></h4>
												<br />
												<h5 class="no-margin">Semester Start : 03-08-2015 </h5>
												<br/>
												<h5 class="no-margin">Semester End : 22-12-2015 </h5>
												<br/>
												<h5 class="no-margin">Days Remaining : 20 </h5>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-md-6">
								<div class="panel">
									<div class="panel-body">
										...
										<h4 class="center"><b>Instructions </b></h4>
                                        <h4 class="center">To view/mark/edit attendance click on the Attendance </h4>
                                        
                                        <h4 class="center">For adding staff/student/subject or assigning staff to subject click on New Additions</h4>
                                        <h4 class="center">For consolidated report click on Consolidated Reports</h4>
									</div>
								</div>
							</div>
