...
<html lang="en">
	<head>
		<title>Admin - Assign Staff to Subjects</title>
		<meta charset="utf-8" />
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Assign Staff<small>Map Staff Members to Subjects</small></h1>
								</div>
							</div>
							...
							<div class="col-sm-7">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="subject_staff_form" role="form" action="add_subject_staff_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="acad" class="form-control search-select">
														<?php
															for($i=2015;$i<2020;$i++)
										                  	{
										                    	$temp = $i + 1;
											...
											<div class="col-sm-4">
												<button class="btn btn-green btn-lg btn-block" type="button" onclick="addRow('dataTable')">Add Row
													<i class="fa fa-plus-circle"></i>
												</button>
											</div>
											<div class="col-sm-4">
												<button class="btn btn-green btn-lg btn-block" type="button" onclick="delRow()">Delete Row
													<i class="fa fa-minus-circle"></i>
												</button>
											</div>
											<div class="col-sm-4">
												<button class="btn btn-green btn-lg btn-block">Submit
									        ...
									        <TABLE id="dataTable" class="table table-striped table-bordered">
									          <TR>
									            <TD class="center"> Sl no. </TD>
									            <TD class="center"> Subject ID </TD>
