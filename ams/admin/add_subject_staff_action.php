				...
				<div class="main-content">
					<div class="container">
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Assign Staff<small>Details of Assigned Staff</small></h1>
								</div>
							</div>
						...
						<?php
						    ...
						    $txtbox1 = $_POST['subid'];
						    $txtbox2 = $_POST['staffid'];
						    $txtbox3 = $_POST['acad'];
						    $txtbox4 = $_POST['sem'];
						    $txtbox5 = $_POST['sem_type'];
						    $successful = array();
						    $unsuccessful = array();
						    $k=$j=0;
						    $n=0;
						    foreach($txtbox2 as $a)
						    {
						    	$n++;
						    }	
						    for($i = 0;$i<$n;$i++) 
						    {
						      	$qry = 'INSERT INTO staff_sub VALUES ("'.$txtbox1[$i].'","'.$txtbox2[$i].'","'.$txtbox3.'","'.$txtbox4.'","'.$txtbox5.'")';
						      	$res=mysqli_query($con,$qry);
						      	if( !$res)
								{
									$unsuccessful[$k][0] = $txtbox1[$i];
									$unsuccessful[$k++][1] = $txtbox2[$i];
								}
								else
								{
									$successful[$j][0] = $txtbox1[$i];
									$successful[$j++][1] = $txtbox2[$i];
								}
							}  
							...
							else
							{
								echo '<h3 class="center">';
									echo 'Staff assigned to Subject Successfully!';
								echo '</h3>';
								echo '<center><b>Academic Year:';
								echo $txtbox3;
								$temp = $txtbox3 + 1;
		                    	$temp %= 100;
		                    	if($temp>9) echo $temp;
								...
								echo 'Semester Type: ';
								echo $txtbox5;
								echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></center>';
							...
							{
								echo '<h3 class="center">';
									echo 'Student Data Not Uploaded (Subject/Teacher already assigned) ';
								echo '</h3>';
								echo '<br/>';
								echo '<center><b>Academic Year: ';
								echo $txtbox3;
