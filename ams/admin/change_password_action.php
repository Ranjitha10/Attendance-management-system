							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										...
										$sql = 'SELECT * from dept_login where username= "'.$name.'" AND password="'.$old.'" ';
										$query = mysqli_query($con,$sql);
										if(mysqli_num_rows($query)==0)
										{
											
											echo '<h3 class="center"> Old Password doesn\'t match. Try again!</h3>';
										}

										else
										{
											$con = mysqli_connect("localhost","root","","attendance");
											$sql = 'UPDATE dept_login SET password = "'.$new.'" where username= "'.$name.'" AND password="'.$old.'" ';
											$query = mysqli_query($con,$sql);

											if($query)
											{
												echo '<h3 class="center"> Password Changed Successfully!</h3>';
											}

											else
											{
												echo '<h3 class="center"> Could Not Change Password!</h3>';
											}
										}

										?>
									
										<h2 class="center"><a href="view_details_admin.php">My Profile</a></h2>
									</div>
								</div>
							</div>
							<div class="col-md-2">
