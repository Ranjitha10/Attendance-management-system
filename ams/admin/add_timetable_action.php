				...
				<div class="main-content">
					<div class="container">
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Upload Timetable<small>Details of Uploaded Timetable</small></h1>
								</div>
							</div>
						...
						<?php
								...
								else
								{
									...
									if (!empty($_FILES["file"]))
									{
										...
										for($i = 2; $i < $row; $i++)
										{
											...
											$sql = ' insert into timetable values( "'.$acad.'" , "'.$sem.'" , "'.$sem_type.'" , "'.$data[$i][1].'" , "'.$data[$i][0].'" , "'.$data[$i][2].'" , "'.$data[$i][3].'") ';
										...
										$temp = $acad + 1;
										$temp %= 100;
										if($temp>9) $ac = $acad.'-'.$temp;
										else $ac = $acad.'-0'.$temp;

										echo '<h3 class="center">';
												echo 'Timetable Upload For '.$sem.' semester of '.$ac.' ';
											echo '</h3>';
											echo '<h3 class="center">';
												echo 'Timetable Uploaded Successfully';
											echo '</h3>';
										echo '<h3 class = "center"><a class="button center" href="add_timetable.php">Back to Upload Page</a></h3>';
							...
							{
								echo '<div class="row"><div class="col-sm-2"></div><div class="col-sm-8"><div class="panel panel-white"><div class="panel-body">';
								echo '<h3 class = "center">Wrong Format Uploaded <br><br> <a class="button center" href="add_timetable.php">Back to Upload Page</a></h3>';
								echo '</div></div></div>';
