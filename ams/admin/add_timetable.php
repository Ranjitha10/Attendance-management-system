						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Upload Timetable<small>Choose file to upload</small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="upload_form" role="form" action="add_timetable_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="portfolio-item center">
												<a class="thumb-info" href="samples/ts.jpg" data-lightbox="gallery" data-title="samples">
