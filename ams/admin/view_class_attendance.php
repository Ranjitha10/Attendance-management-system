...
<html lang="en">
	...
	<li>
					  ...
					  <div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>View Attendance<small>Enter Class Details</small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="attendance_form" id=="attendance_form" role="form" action ="view_class_attendance_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
		...
		<script>
			...
			function validate()
			{
				if(document.forms['attendance_form']['sub_id'].value=="")
				{
