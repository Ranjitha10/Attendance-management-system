						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>My Profile <small>Edit My Profile </small></h1>
								</div>
							</div>
								...
								<div class="col-sm-8">
									...
									<div class="panel panel-white">
										...
										<?php
											...
											$sql = ' UPDATE department SET email="'.$email.'" WHERE dep_id="'.$depid.'" ';
											$query = mysqli_query($con, $sql);

											if($query)
											{
												echo "<h3 class=\"center\"> SUCCESSFULLY UPDATED!</h3>";

												echo "<h4>Department ID :" .$depid;
												echo "</h4>";

												echo "<h4>Email ID : " .$email;
												echo "</h4>";
											}

											else
											{
												echo "<h3 calss=\"center\"> UPDATE FAILED. TRY AGAIN!</h3>";
										...
										?>
										<h2 align="center"><a href="view_details_admin.php">My Profile</a></h2>
										</div>
									</div>
								</div>
							<div class="col-sm-2"></div>
