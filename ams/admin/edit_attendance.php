	...
	<li>
					  ...
					  <div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Edit Attendance<small>Enter student details</small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="edit" id=="attendance_form" role="form" action ="edit_attendance_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-3 control-label" for="form-field-1">
													Select Academic Year
												</label>
												<div class="col-sm-9">
													<select name="acad_year" class="form-control search-select">
														<?php
															for($i=2015;$i<2020;$i++)
										                  	{
										                    	$temp = $i + 1;
										                    	$temp %= 100;
										                    	if($temp>9) echo '<option value='.$i.'>'.$i.'-'.$temp.'</option>';
										                    	else echo '<option value='.$i.'>'.$i.'-0'.$temp.'</option>';
										                  	}
										                ?>
									                </select>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="sem" class="form-control search-select">
														<?php
															for($i=1;$i<9;$i++)
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="sem_type" class="form-control search-select">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="sub_id" id="sub_id" placeholder="Eg. 10IS21">
												</div>
											</div>

											<div class="form-group">
												<label class="col-sm-3 control-label" for="form-field-1">
													Select Date for Editing Attendance
												</label>
												<div class="col-sm-9">
													<input name="date" type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years" class="form-control date-picker">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="class_num" class="form-control search-select">
											...
											<div class = "form-group">
												...
												<div class="col-sm-4">
													<table class="table table-striped table-bordered table-hover table-full-width" id="tableData">
														<tr><td><input name="usn[]" type="text" placeholder="USN" id="usn"></td></tr>
													</table>
												</div>
												<div class="col-sm-3">
													<button type = "button" class="btn btn-green btn-lg btn-block" align = "center" onClick="addRow('tableData')">Add USN
											...
											<div class = "form-group">
												...
												<div class="col-sm-9">
													<textarea name="remarks" id="remarks" placeholder="Enter reason for editing attendance of above students" class="autosize form-control" id="form-field-24"></textarea>
												</div>
											</div>
											
											<button class="btn btn-green btn-lg btn-block" align = "center" onClick="return validate()">Submit
			...
			<footer class="inner">
			  <div class="footer-inner">
				<div class="pull-left">						2015 &copy; RVCE Attendance Managament System by ISE
E
					</div>
			  </div>
			</footer>
		...
		<script>
			...
			function validate()
			{
				...
				var y=document.forms['edit']['remarks'].value;
				if(y=="")
				{
					alert("Please enter remarks!");
					return false;
				}
				var z = document.getElementById("sub_id").value;
				if(z=="")
				{
