...
<html lang="en">
	<head>
		<title>Staff - Mark Regular Attendance</title>
		<meta charset="utf-8" />
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Mark Attendance <small>Regular Class </small></h1>
								</div>
							</div>
										...
										<?php
											...
											else
											{
												...
												//echo $qry;
													...
													{
														//$q1 = 'select max(class_num) where sub_id = "'. $sub .'" and acad_year = "'.$year.'" and semester = "'.$sem.'" and semester_type = "'.$sem_type.'" and class_date = "'. $date .'"';
