				...
				<div class="main-content">
					<div class="container">
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Class Attendance <small>Attendance Report </small></h1>
								</div>
							</div>
						...
						<?php
							...
							$qry = 'select * from staff_sub where acad_year = "'.$year.'" and semester = "'.$sem.'" and semester_type = "'.$sem_type.'" and staff_id = "'.$user.'" ';
								...
								<div class="panel panel-white">
									<div class="panel-body">
										<?php
											...
											{
												echo '<h3 class="center">You do not handle a class for semester '. $sem .'</h3>';
