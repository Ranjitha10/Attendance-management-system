				...
				<div class="main-content">
					<div class="container">
						...
						<div class="panel-body">
							<form method="POST" enctype="multipart/form-data" name="my_form" class="form-inline" action="edit_details_action.php">
									...
									<div class="panel panel-white">
										...
										<?php
											...
											echo "<tr>";
													...
													echo "<td class=\"center\"><input class=\"center\" type=\"text\" name=\"phno\" value=\"$phone\"></td>";
											echo "</tr>";
											...
											<td> 
												<div class="form-group">
													<div class="fileupload fileupload-new contributor-avatar" data-provides="fileupload">
														<div class="fileupload-new thumbnail"><img src="assets/images/anonymous.jpg" alt="" width="200" height="150"/>
													</div>
