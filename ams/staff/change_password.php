...
<li>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										...
										<form name="myform" role="form" action="change_password_action.php" method="POST" class="form-horizontal" onsubmit="return validate()">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name= "old" id = "old" type="password" placeholder="" class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name= "new" id = "new" type="password" placeholder="" class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name= "new1" id= "new1" type="password" placeholder="" class="form-control">
												</div>
											</div>

											<button class="btn btn-green btn-lg btn-block" onclick = "return validate()" align = "center">Change Password
		...
		<script>
			function validate()
			{
				...
				var y = document.getElementById("new1").value;
				...
				if(x.length<6)
				{
					alert("Passwords have to be atleast 6 characters!");
					return false;
				}
			}
		</script>
