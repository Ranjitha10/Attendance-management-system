						...
						<div class="panel-body">
							<form method="POST" id="my_from" class="form-inline" action="edit_profile_action.php">
								...
								<div class="col-sm-8">
									...
									$allowedExts = array('jpg', 'png', 'bmp', 'gif', 'JPG');
									...
									<?php
										...
										$sql = ' UPDATE staff SET email="'.$email.'" , phone="'.$mob.'" , address="'.$addr.'" WHERE staff_id="'.$staffid.'" ';
