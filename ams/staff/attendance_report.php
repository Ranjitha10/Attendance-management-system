...
<li>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<br/>
										<form name="attendance_form" id=="attendance_form" role="form" action ="attendance_report_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
			...
			<footer class="inner">
				<div class="footer-inner">
					<div class="pull-left">
						2015 &copy; RVCE Attendance Management System
					</div>
				</div>
			</footer>
			<!-- end: FOOTER -->
