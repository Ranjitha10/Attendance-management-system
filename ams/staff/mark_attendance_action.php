						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Mark Attendance <small>Details of Marked Attendance </small></h1>
								</div>
							</div>
								...
								<div class="panel panel-white">
									<div class="panel-body">
										<?php
											...
											echo '</div>';
										?>
										<h3 class = "center">Attendance has been updated.</h3>
										<table class="table table-striped table-bordered table-hover table-full-width">
											...
											<?php
												...
												if($held == "true")
												{
													$qry = 'select max(class_num) from attendance where acad_year = "'.$year.'" and semester = "'.$sem.'" and semester_type = "'.$sem_type.'" and sub_id = "'.$sub.'" ';
												...
												for($i=1;$i<=$num;$i++)
												{
													...
													$present = 0;
													$absent = 0;
													$query = 'select * from student_subject where acad_year = "'.$year.'" and semester = "'.$sem.'" and semester_type = "'.$sem_type.'" and sub_id = "'.$sub.'" ';
													...
													while($row = mysqli_fetch_array($result))
													{
													    ...
													    {
													        $q2 = 'insert into attendance values("'.$usn.'","'.$name.'","'.$sub.'",'.$sem.',"'.$sem_type.'","'.$year.'","'.$date.'","'.$j.'","1")';
														...
														{
													        $q3 = 'insert into attendance values("'.$usn.'","'.$name.'","'.$sub.'",'.$sem.',"'.$sem_type.'","'.$year.'","'.$date.'","'.$j.'","0")';
										...
										<br/>
										<h3 class = "center"><a class="button center" href="mark_attendance.php">Back to Mark Attendance page</a></h3>
										<br/>
									</div>
								</div>
							</div>
