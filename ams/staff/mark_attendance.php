...
<html lang="en">
	<head>
		<title>Staff - Mark Attendance</title>
		<meta charset="utf-8" />
					  ...
					  <div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Mark Attendance <small>Enter Class Details </small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="attendance_form" id=="attendance_form" role="form" action ="" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="col-sm-6">
													<button class="btn btn-green btn-lg btn-block" align = "center" onclick="submitForm('mark_regular_attendance.php')">Regular Class
														<i class="fa fa-arrow-circle-right"></i>
													</button>
													</div>
													<div class="col-sm-6">
													<button class="btn btn-green btn-lg btn-block" align = "center" onclick="submitForm('mark_substitution_attendance.php')">Substitution Class
														<i class="fa fa-arrow-circle-right"></i>
													</button>
													</div>
													<script>
										    		...
										    		{
												        document.attendance_form.action = action;
