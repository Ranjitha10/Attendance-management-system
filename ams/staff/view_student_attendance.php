...
<li>
						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>View Attendance <small>Enter Student Details </small></h1>
								</div>
							</div>
							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<form name="attendance_form" id=="attendance_form" role="form" action ="view_student_attendance_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<br/>
											<button class="btn btn-green btn-lg btn-block" onclick = "return validate()" align = "center">Submit
		...
		<script>
			...
			function validate()
			{
				if(document.forms['attendance_form']['usn'].value=="")
				{
