						...
						<div class="toolbar row">
							...
							<div class="col-sm-6" style="color:#336699;">
								...
								<div class="col-sm-10">
									...
									<h6>Mysore Road, RV Vidyaniketan Post, Bagalore - 560 059</h6>
								</div>
							</div>
						</div>
						<!-- end: TOOLBAR -->
								...
								<div class="panel panel-white">
									<div class="panel-body">
										...
										<?php
											...
											$q1 = 'SELECT DISTINCT usn, name from attendance where sub_id like "'.$subid.'" AND acad_year = "'.$acad.'" AND semester = "'.$sem.'" AND semester_type = "'.$semtype.'" ';
											...
											echo'</div>';
												...
												echo '<thead>';
													echo '<tr>';
														...
														echo '<th class="hidden-xs">Classes Held</th>';
														echo '<th class="hidden-xs">Attended</th>';
												...
												while($res = mysqli_fetch_array($r))
												{
													...
													if($per <=85)
													{
														echo "<tr>";
											  			...
											  			echo '<td class="hidden-xs">' . $held . "</td>";
											  			echo '<td class="hidden-xs">' . $att . "</td>";
