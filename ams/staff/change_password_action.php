							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										...
										$sql = 'SELECT * from staff_login where username= "'.$name.'" AND password="'.$old.'" ';
										...
										{
											$con = mysqli_connect("localhost","root","","attendance");
											$sql = 'UPDATE staff_login SET password = "'.$new.'" where username= "'.$name.'" AND password="'.$old.'" ';
											$query = mysqli_query($con,$sql);
											...
											if($query)
											{
												...
												$sql = ' SELECT * from staff where staff_id="'.$name.'" ';
												$query = mysqli_query($con,$sql);
												$res = mysqli_fetch_array($query);

												$to_value= $res['email'];
												$password = $new;
												$mess = "Your username is ".$name." and password is ".$password;
