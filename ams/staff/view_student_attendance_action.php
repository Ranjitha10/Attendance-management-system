						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Student Attendance <small>Attendance Report </small></h1>
								</div>
							</div>
								...
								<div class="panel panel-white">
									<div class="panel-body">
										<?php
											...
											{
												echo '<h3 class="center">Invalid USN : '. $usn .'</h3>';
												echo '<h3 class = "center"><a class="button center" href="view_student_attendance.php">Back to View Student Attendance page</a></h3>';
											}
											else
											{
												...
												$q1 = 'select * from student_subject where acad_year = "'.$year.'" and semester = '.$sem.' and semester_type = "'.$sem_type.'" and usn = "'.$usn.'" ';
												$res1 = mysqli_query($con,$q1);
												if(mysqli_num_rows($res1)==0)
												{
													echo '<h3 class="center">You have not registered for any subject in the specified semester.</h3>';
													//echo '<h3 class = "center"><a class="button center" href="view_student_attendance.php">Back to View Student Attendance page</a></h3>';
												...
												else
												{
													...
													while($row1 = mysqli_fetch_array($res1))
													{
														...
														$attended = 0;
														$sub = $row1['sub_id'];
														$q3 = 'select * from subject where sub_id = "'. $sub .'"';
											            ...
											            echo '<td>'. $attended .'</td>';
											            echo '<td>'. $held .'</td>';
											            echo '<td><div class="col-sm-4"><span style="color:'.$col.';">'.$per.'</span></div>';?>
												...
												echo '<br/><h3 class = "center"><a class="button center" href="view_student_attendance.php">Back to View Student Attendance page</a></h3>';
											}
										?>
										<br/>
										<br/>
