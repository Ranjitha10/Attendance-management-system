							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										...
										<form name="myform" role="form" action="change_password_action.php" method="POST" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="old_pwd" id = "old" type="password" placeholder="" class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="new_pwd" id = "new" type="password" placeholder="" class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="c_new_pwd" id = "new1" type="password" placeholder="" class="form-control">
												</div>
											</div>
