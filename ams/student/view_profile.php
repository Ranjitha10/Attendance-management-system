						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Profile<small>My Profile </small></h1>
								</div>
							</div>
							...
							<form method="POST" id="my_from" class="form-inline" action="edit_profile_action.php">
								...
								<?php
									...
									echo "<tr>";
											...
											echo "<td class=\"center\">$father_phone</td>";
									echo "</tr>";

									echo "<tr>";
											echo "<td class=\"center\">Father Email</td>";
											echo "<td class=\"center\">$father_email</td>";
									echo "</tr>";
								...
								<div class="col-sm-6">
									...
									<button type="button" class="btn btn-green btn-lg btn-block" align = "center" >Change Password
										<i class="fa fa-arrow-circle-right"></i>
									</button></a>
								</div>
								<div class="col-sm-6">
									<a href="edit_profile.php">
									<button type="button" class="btn btn-green btn-lg btn-block" align = "center" >Edit Profile
										<i class="fa fa-arrow-circle-right"></i>
									</button></a>
								</div>
							</div>
