	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
				<div class="box-login">
					<div class="panel-orange" style="border-radius:6px;">
						<div class="row">
							<div class="col-md-2">
							...
							<div class="col-md-10">
								<h2 class="center">RVCE Attendance Management System</h2>
								<h3 class="center">Sign in as Student</h3>
							</div>
						</div>
					</div>
					<br />
					<h4 class="center">
						Please enter the USN and password to log in.
					</h4>
					<form class="form-login" action="login_confirm.php" method="post">
						<div class="errorHandler alert alert-danger">
							<i class="fa fa-remove-sign"></i> USN or Password is worng. Please try again.
						</div>
						<fieldset>
