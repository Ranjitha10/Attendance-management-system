						...
						<div class="toolbar row">
							<div class="col-sm-4 hidden-xs">
								<div class="page-header">
									<h1>Attendance Details <small>Report </small></h1>
								</div>
							</div>
									...
									<div class="panel-body">
										<?php
											...
											else
											{
												...
												{
													echo '<h3 class="center">No attendance uploaded for the specified semester.</h3>';
												}
												else
												{
												...
												echo '</tbody></table>';
												echo '<br/><h3 class = "center"><a class="button center" href="view_attendance.php">Back to View Attendance page</a></h3>';
											}
										?>
										<br/>
										<br/>
