							...
							<div class="col-sm-8">
								<div class="panel panel-white">
									<div class="panel-body">
										<br/>
										<form name="attendance_form" id=="attendance_form" role="form" action ="view_attendance_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
